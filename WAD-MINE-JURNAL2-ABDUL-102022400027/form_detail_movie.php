                    ...
                    <div class="card shadow-sm p-3">
                        <div class="card-body">
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="title" value="<?= htmlspecialchair($movies["title"])" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="genre" value="<?= htmlspecialchair($movies["genre"])" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="director" value="<?= htmlspecialchair($movies["director"])" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="release_year" value="<?= htmlspecialchair($movies["release_year"])" disabled>

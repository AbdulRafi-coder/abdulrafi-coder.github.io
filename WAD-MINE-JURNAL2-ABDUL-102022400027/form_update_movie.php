        ...
        <div class="card shadow p-4 mx-auto" style="max-width: 600px;">
            ...
            <form action="update.php" method="POST">
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="text" class="form-control" name="title" value="" placeholder="Judul Film" required>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="text" class="form-control" name="genre" value="" placeholder="Genre (Aksi, Drama, dll.)" required>
                    <label>Genre</label>
                </div>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="text" class="form-control" name="director" value="" placeholder="Nama Sutradara" required>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="number" class="form-control" name="release_year" value="" placeholder="Tahun Rilis" min="1900" max="<?= date('Y'); ?>" required>

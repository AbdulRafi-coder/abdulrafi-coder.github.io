        ...
        <div class="card shadow p-4">
            ...
            <form action="create.php" method="POST">
                <div class="form-floating mb-3">
                    ...
                    <input type="text" class="form-control" name="" placeholder="Judul Buku" required>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="text" class="form-control" name="" placeholder="Penulis" required>
                    <label>Penulis</label>
                </div>
                <div class="form-floating mb-3">
                    <!-- ====================6================= -->
                    <!-- Isi attribute name input untuk stok yang harus diisi -->
                    <input type="number" class="form-control" name="" placeholder="Stok" min="0" required>
                    <label>Stok</label>
                </div>
